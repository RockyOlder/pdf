...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="coupon_add" enctype="multipart/form-data" name="coupon_add" method="post" action="<?php echo U('Admin/GoodsFreeRecommend/doAdd');?>" onsubmit="return addRecommend();">
        <table class="tbForm" width="100%" id="wrap">
            <thead>
                <tr class="title">
                    <th colspan="99">新增自由搭配</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="first">* 搭配名称：</td>
                    <td>
                    	<input type="text"  value="" id="fr_name" name="fr_name" onblur='checkGname(this)' class="large" maxlength="60"/>
                ...
                <tr>
                    <td class="first">* 搭配商品：</td>
                    <td>
                        <input type="hidden" id="fr_original_price" name="fr_original_price" value="0" />
                        <select name="g_id" style="width:auto" class="medium" id="g_related_goods_ids_selected_info" onchange="showPic()" validate="{ required:true}">
                        	<option value="0">请先搜索商品,再次生成选项列表</option>
                        	
                        </select>
                        <span class="gname_error" style="color:#ff0000;"></span>
                        <img width="50px" height="50px" src="" id="show_pic" style="position:absolute;">
                        <input type="hidden" name="fr_goods_picture" id="fr_goods_picture" value="" />
                    </td>
                    
                    
                </tr>
                <tr>
                    <td class="first">* 搭配价：</td>
                    <td>
                        <input type="text"  value="" class="small" name="fr_price" id="fr_price" />
                        <span class="gname_error" style="color:#ff0000;"></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" value="0000-00-00 00:00:00" name="fr_statr_time" id="fr_statr_time" class="medium timer" />
                        	至
                        <input type="text" value="0000-00-00 00:00:00" name="fr_end_time" id="fr_end_time" class="medium timer" />
                    </td>
                    <td class="last"></td>
                </tr> 				
	            <tr>
                    ...
                    <td>
                        <input type="checkbox" onclick="checkedStatus(this);"  checked value="1" />
                        <input type="hidden" name="fr_status" id="fr_status" value="1"  />
                    </td>
...
<script src="__PUBLIC__/Admin/js/admin-recommend.js"></script>
                <?php } ?>
