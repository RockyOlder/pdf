...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <span id="tabListP2" <?php if($tabs == 'PrepaidRecords'): ?>class="onHover"<?php endif; ?> > 充值记录</span>
</p>
<div id="content">
   <div class="rightInner" id="tabList1">
       <table class="tbList" width="100%">
            ...
            <tbody>
                                <?php if(is_array($ary_PaymentSerial)): $k = 0; $__LIST__ = $ary_PaymentSerial;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$PaymentSeriallist): $mod = ($k % 2 );++$k;?><tr>
