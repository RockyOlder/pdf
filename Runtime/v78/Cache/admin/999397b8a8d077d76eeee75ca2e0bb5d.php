...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="rolenode_form" name="rolenode_form" method="post" action="<?php echo U('Admin/RoleNode/doAdd');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">添加节点</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="action" id="action" class="medium" value=""/> <br> 
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="action_name" id="action_name" class="medium" value=""/> <br> 
                    </td>
                </tr>
                <tr>
                    <td class="first">模块：</td>
                    <td>
                        <input type="text" name="module" id="module" class="medium" value="" validate="{ required:true,maxlength:60}"/> <br> 
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="module_name" id="module_name" class="medium" value="" validate="{ required:true,maxlength:60}"/> <br> 
                    </td>
                </tr>
                <tr>
                    <td class="first">节点排序：</td>
                    <td>
                        <input type="text" name="sort" id="sort" class="medium" value="10" validate="{ required:true,rangelength:[1,6],digits:true}"/> <br> 
                    </td>
                </tr>
                <tr>
