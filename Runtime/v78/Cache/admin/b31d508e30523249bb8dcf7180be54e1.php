    ...
    <table class="tbForm" width="100%">
        <tbody class="tab">
            ...
            <tr class="inputClass">
                ...
                <td class="inputClass"><input type="hidden" name="bi_type" id="bi_type" value="1"><input type="text" class="input01" name="o_id" value="" id="o_id" validate="{ required:true,maxlength:30,remote:'<?php echo U('Admin/BalanceInfo/checkName');?>'
}"></td>
                <td width="236px"></td>
            </tr>
            <tr class="inputClass">
                <td align="right"><font color="red">*</font>扣除金额：</td>
                <td class="inputClass"><input type="text" class="input01" name="bi_money" value="" id="bi_balance_money" validate="{ required:true}"></td>
                <td width="236px"></td>
            </tr>
            <tr class="inputClass">
