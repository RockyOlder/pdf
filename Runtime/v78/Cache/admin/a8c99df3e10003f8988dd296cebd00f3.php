 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <table width="100%" class="tbList">
        <thead>
            ...
            <tr>
                <th width="120">操作</th>
                <th width="120" class="left" >SEO项</th>
                <th class="left">SEO内容</th>
            </tr>
        </thead>
        <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$seo): $mod = ($i % 2 );++$i;?><tr>
                <td width="120">
                    <a href='<?php echo U("Admin/Seo/pageEdit","skey=$seo[sc_key]");?>'>编辑</a>
                </td>
                <td class="left"><?php echo ($seo["sc_value_desc"]); ?></td>
                <td class="left"><?php echo ($seo["sc_value"]); ?></td>
