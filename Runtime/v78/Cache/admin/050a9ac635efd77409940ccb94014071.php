...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="online_config" method="post" action="<?php echo U('Admin/Financial/doConfigOnline');?>">
        <table class="tbForm" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td class="first">* 微信支付商户号</td>
                    <td>
                        <input type="text" name="weixin_account" class="large" value="<?php echo ($info["config"]["weixin_account"]); ?>" validate="{ required:true}" />
                    </td>
                    <td class="last"><a href="http://kf.qq.com/faq/140225MveaUz150107UVFNjy.html" target="_blank">微信支付申请指引</a></td>
                </tr>
				<tr>
                    <td class="first">* APPID</td>
                    <td>
                        <input type="text" name="weixin_appid" class="large" value="<?php echo ($info["config"]["weixin_appid"]); ?>" validate="{ required:true}" />
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    <td class="first">* AppSecret</td>
                    <td>
                        <input type="text" name="weixin_appsecret" class="large" value="<?php echo ($info["config"]["weixin_appsecret"]); ?>" validate="{ required:true}" />
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    <td class="first">* 商户支付密钥Key</td>
                    <td>
                        <input type="text" name="weixin_key" class="large" value="<?php echo ($info["config"]["weixin_key"]); ?>" validate="{ required:true}" />
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    <td class="first">JS API网页支付授权目录</td>
                    <td>
						<?php echo ($hostUrl); ?>
                    </td>
                    <td class="last">申请时以此目录地址申请即可</td>
                </tr>	
<!--				
                <tr>
                    <td class="first">Native原生支付回调URL</td>
                    <td>
						<?php echo ($hostUrl); ?>
                    </td>
                    <td class="last">申请时以此目录地址申请即可</td>
	...
	-->		
                <tr>
                    ...
                    <td>
                        <input type="text" name="pc_fee" class="small" value="<?php echo ($info["pc_fee"]); ?>"  validate="{ number:true, min:0}" />%
                    </td>
            ...
            <tfoot>
                <tr>
                    <td colspan="99">
                        <input type="hidden" value="WEIXIN" name="code" />
