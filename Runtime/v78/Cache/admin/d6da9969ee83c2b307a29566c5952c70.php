...
<p class="tabListP" id="tabs">
    <span id="tabListP1" <?php if($filter["tabs"] == 'website'): ?>class="onHover"<?php endif; ?>><a href='<?php echo U("Admin/Products/pageList","tabs=website");?>'>官网商品</a></span>
    <span id="tabListP2" <?php if($filter["tabs"] == 'shelves'): ?>class="onHover"<?php endif; ?> ><a href='<?php echo U("Admin/Products/pageList","tabs=shelves");?>'>下架商品</a></span>
    <span id="tabListP4" <?php if($filter["tabs"] == 'recycle'): ?>class="onHover"<?php endif; ?> ><a href='<?php echo U("Admin/Products/pageList","tabs=recycle");?>'>回收站</a></span>
    <span id="tabListP5" <?php if($filter["tabs"] == 'new'): ?>class="onHover"<?php endif; ?> ><a href='<?php echo U("Admin/Products/pageList","tabs=new");?>'>新品</a></span>
    <span id="tabListP6" <?php if($filter["tabs"] == 'hot'): ?>class="onHover"<?php endif; ?> ><a href='<?php echo U("Admin/Products/pageList","tabs=hot");?>'>热品</a></span>
</p>
<div id="content">
    <div class="rightInner" id="con_tabListP_1"><!--rightInner  start-->
        <table width="100%" class="tbList">
            ...
            <p class="conOneP" style="float: left;padding-left:0px;">
                ...
                <?php if($filter["tabs"] == 'recycle'): ?><a href="javascript:void(0);" onclick="return isBatGoods(this);" data-uri='<?php echo U("Admin/Products/isBatGoods");?>' field="g_status" val="1" class="btnG ico_refresh">批量移除回收站</a>
                    <a href="javascript:void(0);" onclick="return isBatGoods(this);" data-uri='<?php echo U("Admin/Products/doGoodsisDel");?>' class="btnG ico_del">批量删除</a><?php endif; ?>
                <?php if($filter['tabs'] != 'recycle' && $filter['tabs'] != 'shelves'): ?><a href="javascript:void(0);" onclick="return isBatGoods(this);" data-uri='<?php echo U("Admin/Products/isBatGoods");?>' field="g_on_sale" val="2" class="btnG Set">批量下架</a><?php endif; ?>
                <?php if($filter["tabs"] == 'shelves'): ?><a href="javascript:void(0);" onclick="return isBatGoods(this);" data-uri='<?php echo U("Admin/Products/isBatGoods");?>' field="g_on_sale" val="1" class="btnG Set">批量上架</a><?php endif; ?>
                <?php if($filter['tabs'] != 'recycle' && $filter['tabs'] != 'shelves'): ?><a href="javascript:void(0);" onclick="return getCheckedProducts(this);" class="btnG ico_sto">调整库存</a>
                <a href="javascript:void(0);" onclick="fastBelongToGroup();" class="btnG Set">快速归组</a><?php endif; ?>
                <?php if($filter["tabs"] != 'recycle'): ?><a href="javascript:void(0);" onclick="return isBatGoods(this);" data-uri='<?php echo U("Admin/Products/isBatGoods");?>' field="g_status" val="2" class="btnG ico_del2">批量加入回收站</a><?php endif; ?>
				<a href="javascript:void(0);" onclick="fastUpdateTitle();" class="btnG Set">批量更改标题</a>
                <?php if($filter['tabs'] != 'recycle' && $filter['tabs'] != 'shelves'): ?><select class="medium" id="removeGroupGoodsIn">
					<option value="0" selected="selected">批量加入分组</option>
				...
				<select class="medium" id="removeGroupGoodsOut">
					<option value="0" selected="selected">批量移出分组</option>
					<?php if(is_array($goodsgroups)): $i = 0; $__LIST__ = $goodsgroups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gg): $mod = ($i % 2 );++$i;?><option value="<?php echo ($gg["gg_id"]); ?>"><?php echo ($gg["gg_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select><?php endif; ?>
                
                <select class="medium" id="removeGoodsCategoryIn">
					<option value="0" selected="selected">批量加入分类</option>
					<?php if(is_array($array_category)): $i = 0; $__LIST__ = $array_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gc): $mod = ($i % 2 );++$i;?><option value="<?php echo ($gc["gc_id"]); ?>"><?php echo ($gc["gc_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				<select class="medium" id="removeGoodsCategoryOut">
					<option value="0" selected="selected">批量移出分类</option>
					<?php if(is_array($array_category)): $i = 0; $__LIST__ = $array_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gc): $mod = ($i % 2 );++$i;?><option value="<?php echo ($gc["gc_id"]); ?>"><?php echo ($gc["gc_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
            </p>
