...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="role_form" name="role_form" method="post" action="<?php echo U('Admin/Role/doAdd');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">角色添加</th>
                </tr>
            </thead>
            <tbody style="">
                <tr>
                    ...
                    <td>
                        <input type="text" name="name" id="name" class="medium" value="<?php echo ($vo["name"]); ?>" validate="{ required:true,maxlength:30,remote:'<?php echo U('Admin/Role/checkRoleName');?>'
                               }"/> <br> 
                    </td>
                </tr>
                <tr>
            ...
            <?php if(is_array($access_list)): $i = 0; $__LIST__ = $access_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    <td class="first" style="padding-top:5px;line-height: 24px;vertical-align: top;border-right: 1px;text-align: left;">
                        <p>
                            <label>
                                <input class="module-item" type="checkbox" name="access_node[]" value="<?php echo ($list["id"]); ?>" style="vertical-align:-3px;padding: 0px;margin-right: 3px;">
                    ...
                    <td colspan="2" style="">
                        <p>	
                            ...
                            <div class="role_div" style="width:400px;">
                                <ul>
                                    <?php if(is_array($list["actions"])): $i = 0; $__LIST__ = $list["actions"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$action): $mod = ($i % 2 );++$i;?><li style=" float: left;height: 25px;width: 33%;line-height: 25px;overflow: hidden;">
                                            <label>
                                                <input class="action-item" type="checkbox" name="access_node[]" value="<?php echo ($action["id"]); ?>" key="k" style="vertical-align:-3px;padding: 0px;margin-right: 3px;">
