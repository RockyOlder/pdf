...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="online_config" method="post" action="<?php echo U('Admin/Financial/doConfigOnline');?>" enctype="multipart/form-data">
        <table class="tbForm" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td class="first">* 商户代码</td>
                    <td>
                        <input type="text" name="MERCHANT_ID" value="<?php echo ($info["config"]["MERCHANT_ID"]); ?>"/>
                    </td>
                    <td class="last">交行发放的商户唯一标示</td>
                </tr>
                <tr>
                    <td class="first">* 商户证书</td>
                    <td>
                        <input type="file" name="SIGN_CERT_PATH" />
                    </td>
                    <td class="last">格式为.pfx的 证书文件</td>
                </tr>
                <tr>
                    <td class="first"></td>
                    <td>
                     	已保存文件路径: <?php echo ($info["config"]["SIGN_CERT_PATH"]["upload_path"]); ?>&nbsp;&nbsp;&nbsp;上传时间：<?php echo ($info["config"]["SIGN_CERT_PATH"]["upload_time"]); ?>
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    <td class="first">* 商户证书密码</td>
                    <td>
                        <input type="text" name="SIGN_CERT_PWD" value="<?php echo ($info["config"]["SIGN_CERT_PWD"]); ?>"/>
                    </td>
                    <td class="last">签名用私钥文件密码</td>
                </tr>
                <tr>
                    <td class="first">* 验签证书文件</td>
                    <td>
                        <input type="file" name="VERIFY_CERT_PATH" />
                    </td>
                    <td class="last">格式为.cer的证书文件</td>
                </tr>
                <tr>
                    <td class="first"></td>
                    <td>
                        已保存文件路径: <?php echo ($info["config"]["VERIFY_CERT_PATH"]["upload_path"]); ?>&nbsp;&nbsp;&nbsp;上传时间：<?php echo ($info["config"]["VERIFY_CERT_PATH"]["upload_time"]); ?>
                    </td>
                    <td class="last"></td>
                </tr>
            </tbody>
            ...
            <tfoot>
                <tr>
                    <td colspan="99">
                        <input type="hidden" value="BOCOMPAY" name="code" />
