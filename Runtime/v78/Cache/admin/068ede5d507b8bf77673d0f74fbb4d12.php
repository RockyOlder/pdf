    ...
    <table width="100%" class="tbList">
        <thead>
            ...
            <tr>
				<th width="120">操作</th>
				<th>客服名称</th>
				<th width="120">客服类型</th>
				<th width="120">客服分类</th>
				<th width="120">是否启用</th>
            </tr>
        </thead>
        <tbody>
           	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$onlineservice): $mod = ($i % 2 );++$i;?><tr>
                  <td width="120">
                   <a href='<?php echo U("Admin/Online/pageEdit","oid=$onlineservice[o_id]");?>'>编辑</a>|
				<a href='<?php echo U("Admin/Online/doDel","oid=$onlineservice[o_id]");?>'>删除</a>
				</td>
				<td><?php echo ($onlineservice["o_name"]); ?></td>
				<td width="120"><?php echo ($onlineservice[o_type]==1?'QQ客服':'旺旺客服'); ?></td>
				<td width="120"><?php echo ($onlineservice["oc_name"]); ?></td>
				<td width="120"><?php echo ($onlineservice['o_status']?'已启用':'未启用'); ?></td>
