        ...
        <table width="100%" class="tbList">
            <thead>
                <tr class="title">
                    ...
                    <th colspan="99" >
                        <a href='<?php echo U("Admin/Sourceplatform/pageAdd");?>' class="btnG ico_add">添加平台</a>
                    </th>
                </tr>
                 <form method="get" action="<?php echo U('Admin/Sourceplatform/doDel');?>" id="members_del">
                <tr>
            ...
            <tbody>
            <?php if(is_array($platfrom)): $i = 0; $__LIST__ = $platfrom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$plf): $mod = ($i % 2 );++$i;?><tr id="list_<?php echo ($plf[sp_id]); ?>">
                    <td><?php if($plf[sp_default] == 0): ?><input type="checkbox" class="checkSon" name="sp_id[]" value="<?php echo ($plf["sp_id"]); ?>" /><?php endif; ?></td>
                    <td>  
                    	<?php if($plf[sp_default] == 1): ?><span style="font-family:Arial;font-weight:normal;font-style:normal;text-decoration:none;color:#666666;">编辑&nbsp;删除</span>
                    	<?php elseif($plf[sp_default] == 0): ?>
                         <a href='<?php if($plf[sp_default] != 1): echo U("Admin/Sourceplatform/pageEdit?sp_id=$plf[sp_id]"); else: ?>javascript:void(0)<?php endif; ?>' >编辑</a> 
                        <a href='<?php if($plf[sp_default] != 1): echo U("Admin/Sourceplatform/doDel?sp_id=$plf[sp_id]"); else: ?>javascript:void(0)<?php endif; ?>' class="confirm">删除</a><?php endif; ?>
 
                    </td>
                    <td><?php echo ($plf["sp_name"]); ?></td>
                    <!--  <td class="left"><?php echo ($members["m_balance"]); ?></td>-->
                    <td><?php if($plf[sp_default] == 1): ?>系统<?php elseif($plf[sp_default] == 0): ?>自定义<?php endif; ?></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            <?php if(empty($platfrom)): ?><tr><td colspan="99" class="left">暂时没有数据!</td></tr><?php endif; ?>
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="99"><input type="button" data-uri='<?php echo U("Admin/Sourceplatform/doBatDelPlat");?>' data-field="m_id" value="删除选中" class="btnA confirm" id="delAll" /><span class="right page"><?php echo ($page); ?></span></td>
                </tr>
            </tfoot>
        </table>
    </form>
