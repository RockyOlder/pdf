...
<form id="noticeForm" method="post" action="/Admin/Email/doEdit">
	<table class="tbForm" width="100%">
		<thead>
			<tr class="title">
				<th colspan="99">邮件模板设置</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td class="first"><span class="red">*</span>邮件模板：</td>
				<td>
					<select style="width: auto" class="small" name="temp_id" id="temp_id" onchange="changetemp()">
						<option value="0">选择模板类型</option>
						<option value="1">忘记密码邮件通知</option>
						<option value="2">邮箱验证</option>
                                                <option value="3">发送附件通知</option>
					</select>
				</td>
			</tr>
