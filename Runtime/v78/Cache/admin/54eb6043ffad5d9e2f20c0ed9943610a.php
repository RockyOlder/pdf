...
<div class="rightInner">
    <form id="brand_form" name="brand_form" method="post" enctype="multipart/form-data" action="<?php echo U('Admin/Goods/doBatchAddGoods');?>" onsubmit="return javascriptCheckBeforeSubmit();">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">批量新增商品</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="first">下载EXCEL模板：</td>
                    <td>
                        <a class="btnG ico_upload" href="/Public/upload/excel/goods_excle_template.xlsx">点击下载excel模板</a>
                    </td>                    
                </tr>
                <tr>
                    <td class="first">上传文件：</td>
                    <td>
            ...
            <tfoot>
                <tr>
                    <td colspan="99">
                        ...
                        <input type="button" value="单个添加商品" onClick="onUrl('<?php echo U("Admin/Goods/goodsAdd");?>');" class="btnA" >
                    </td>
                </tr>
            </tfoot>
        </table>
