...
<div class="rightInner">
    <form id="category_form" name="category_form" method="post" action="<?php echo U('Admin/GoodsCategory/doEdit');?>" enctype="multipart/form-data">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">商品分类添加</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" name="gc_name" id="gc_name" size="25" maxlength="20" class="medium" value="<?php echo ($category["gc_name"]); ?>" validate="{required:true}" /> <span style="color:red;">*</span></span><br>
                        <input type="hidden" value="<?php echo ($category["gc_id"]); ?>"  name="gc_id" id="gc_id" /> 
                        <input type="hidden" value="<?php echo ($category["gc_name"]); ?>"  name="gcname" id="gcname" /> 
                    </td>      
                    <td class="last">限制20个文字</td>              
                </tr>
                <tr>
                    <td class="first">上级分类：</td>
                    <td>
	                    <select name="gc_parent_id" id="gc_parent_0">
	                      	<option value="0">--作为一级分类--</option>
	                        <?php echo ($option_html); ?>
	                    </select><br> 
                    </td>
                    <td class="last">顶级分类请选择“作为一级分类”</td>
                </tr>
                <tr>
                    <td class="first">排序：</td>
                    <td>
                        <input name="gc_order" class="medium" type="text" id="gc_order" size="25" maxlength="10" value="<?php echo ($category["gc_order"]); ?>"> <span style="color:red;">*</span><br> 
                    </td>
                    <td class="last">数字越小越靠前</td>
                </tr>
                <?php if(!empty($GCTYPE)): ?><tr>
                    <td class="first">分类属性：</td>
                    <td>
	                    <input type="radio" name="gc_type" value="0" <?php if($category["gc_type"] == 0): ?>checked<?php endif; ?> id="gc_type_0" />
	                    <label for="gc_type_0">普通</label>
	                    &nbsp;&nbsp;&nbsp;&nbsp;
	                    <input type="radio" name="gc_type" value="1" <?php if($category["gc_type"] == 1): ?>checked<?php endif; ?> id="gc_type_1" />
	                    <label for="gc_type_1">楼层</label>
	                    &nbsp;&nbsp;&nbsp;&nbsp;
	                    <input type="radio" name="gc_type" value="2" <?php if($category["gc_type"] == 2): ?>checked<?php endif; ?> id="gc_type_2" />
	                    <label for="gc_type_2">店铺</label>
                    </td>
                    <td class="last"></td>
                </tr><?php endif; ?>
                <tr>
                    ...
                    <td>
	                    <input type="radio" name="gc_is_display" value="1" <?php if($category["gc_is_display"] == 1): ?>checked<?php endif; ?> id="gc_is_display_true" />
	                    <label for="gc_is_display_true">是</label>
	                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    <input type="radio" name="gc_is_display" value="0" <?php if(($category["gc_is_display"] == 0) or ($category["gc_is_display"] == '')): ?>checked<?php endif; ?> value="0" id="gc_is_display_false" />
                ...
                <tr>
                    ...
                    <td>
	                    <input type="radio" name="gc_is_hot" value="1" <?php if($category["gc_is_hot"] == 1): ?>checked<?php endif; ?> id="gc_is_hot_true" />
	                    <label for="gc_is_hot_true">是</label>
	                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    <input type="radio" name="gc_is_hot" value="0" <?php if(($category["gc_is_hot"] == 0) or ($category["gc_is_hot"] == '')): ?>checked<?php endif; ?> value="0" id="gc_is_hot_false" />
	                    <label for="gc_is_hot_false">否</label>
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    <td class="first">类目图片：</td>
                    <td>
                        <a href="javascript:upImage();" class="btnG ico_upload">上传图片</a>
						<img width="50px" height="50px" src="<?php echo (C("DOMAIN_HOST")); echo ($category["gc_pic_url"]); ?>" id="show_pic">
                        &nbsp;
                        <input type="hidden" id="gc_pic_url" name="gc_pic_url" />
                    </td>
                    <td class="last">
                ...
                <tr>
                    ...
                    <td>
                        <input name="gc_keyword" class="medium" type="text" value="<?php echo ($category["gc_keyword"]); ?>" id="gc_keyword" size="25" > <br> 
                    </td>
                    <td class="last">数字越小越靠前</td>
                </tr>
				<tr>
                   <td class="first">分类描述：</td>
                    <td>
                        <textarea class="mediumBox"  name="gc_description" id="gc_description" ><?php echo ($category["gc_description"]); ?></textarea>
                    </td>
                    <td class="last"></td>
                </tr> 
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="99">
                        ...
                        <input type="button" value="取 消" onClick="onUrl('<?php echo U('Admin/GoodsCategory/pageList');?>');" class="btnA" >
                    </td>
                </tr>
            </tfoot>
        </table>
