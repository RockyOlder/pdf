...
<div class="rightInner">
    <form id="members_form" name="members_form" method="post" action="<?php echo U('Admin/Sourceplatform/doAdd');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">会员来源平台添加</th>
                </tr>
            </thead>
            <tbody> 
                <tr>
                    ...
                    <td>
                        <input type="text" name="sp_name" id="sp_name" class="medium" value="" validtae="{ required:true}"/> <br> 
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="sp_code" id="sp_code" class="medium" value="" validate='{ required:true,username:true,remote:"<?php echo U("Admin/Sourceplatform/checkSourceplatformCode","filed=sp_code&msg=等级代码");?>"}' /> <br> 
                    </td>
