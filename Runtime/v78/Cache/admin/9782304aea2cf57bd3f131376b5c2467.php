...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="rules_add" name="rules_add" method="post" action="<?php echo U('Admin/Coupon/doRulesAdd');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">新增抢优惠券规则</th>
                </tr>
            </thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" name="rd_name" class="medium" validate="{ required:true}" />
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="rd_start_time" id="rd_start_time" class="medium timer" validate="{ required:true}"/> 
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="rd_end_time" id="rd_end_time" class="medium timer" validate="{ required:true}"/>
                    </td>
                    <td class="last"></td>
                </tr>
                <tr> 
                    ...
                    <td colspan="2" style="">
                        <?php if(is_array($coupon)): $i = 0; $__LIST__ = $coupon;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><input type="checkbox" name="c_name[]" value="<?php echo ($c["c_name"]); ?>" style="vertical-align:-3px;padding: 0px;margin-right: 3px;">
                        <span><?php echo ($c["c_name"]); ?>（剩余<?php echo ($c["nums"]); ?>张）</span><?php endforeach; endif; else: echo "" ;endif; ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="rd_memo" class="mediumBox" validate="{ maxlength:200}"></textarea>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="large" value="" name="rd_title">
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="large" value="" name="rd_keywords">
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea name="rd_description" class="mediumBox"></textarea>
                    </td>
                    <td class="last"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="rd_is_status" id="rd_is_status" value="1"/>
                    </td>
                    <td class="last"></td>
                </tr>
            </tbody>
...
<script type="text/javascript">
    ...
    function save(){
        ...
        var res = $('#rules_add').valid();
        if(res){
            document.rules_add.submit();
        }
    }
</script>
                <?php } ?>
