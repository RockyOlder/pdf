...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="coupon_set" name="coupon_set" method="post" action="<?php echo U('Admin/Coupon/doCouponSet');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">优惠券设置</th>
                </tr>
            </thead>

            <tbody>
                <tr>
                    <td class="first">是否启用优惠券</td>
                    <td>
                        <input type="radio" name="COUPON_AUTO_OPEN" value="1" <?php if(($COUPON_AUTO_OPEN) == "1"): ?>checked="checked"<?php endif; ?> />
                        <label for="water_on_1">开启</label>

                        <input type="radio" name="COUPON_AUTO_OPEN"  value="0" <?php if(($COUPON_AUTO_OPEN) == "0"): ?>checked="checked"<?php endif; ?> />
                        <label for="water_on_2">关闭</label>
                    </td>
                    <td class="last">开启后，会员中心开放优惠券功能</td>
                </tr>
            </tbody>
