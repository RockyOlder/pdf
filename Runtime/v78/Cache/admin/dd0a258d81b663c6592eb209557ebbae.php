...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <table width="100%" class="tbList">
        <thead>
            <tr class="title">
                <th colspan="99"><a href="<?php echo U('Admin/Source/pageAdd');?>" class="btnG ico_add">新增来源</a></th>
            </tr>
            <tr>
				<th width="120">操作</th>
				<th>来源名称</th>
        ...
        <tbody>
           	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?><tr>
                  <td width="120">
                   <a href='<?php echo U("Admin/Source/pageEdit","ulid=$link[s_id]");?>'>编辑</a>|
				<a href='<?php echo U("Admin/Source/doDel","s_id=$link[s_id]");?>'>删除</a>
				</td>
