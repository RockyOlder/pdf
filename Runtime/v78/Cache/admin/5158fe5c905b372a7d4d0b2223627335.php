...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form action="<?php echo U('Admin/RefundsProperty/doDelSpec');?>" method="POST" onsubmit="return beforeDeleteConfirm();">
    <table width="100%" class="tbList">
        ...
        <tbody>
            <?php if(is_array($ary_spec)): $i = 0; $__LIST__ = $ary_spec;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$spec): $mod = ($i % 2 );++$i;?><tr>
                <td><input type="checkbox" class="checkSon" name="gs_id[]"  value="<?php echo ($spec["gs_id"]); ?>" /></td>
                <td>
				    <a href='<?php echo U("Admin/RefundsProperty/specEditPage?gsid=$spec[gs_id]");?>'>编辑</a> 
                    <a href='<?php echo U("Admin/RefundsProperty/doDelSpec?gsid=$spec[gs_id]");?>' class="confirm">删除</a>
				</td>
                <td><?php echo ($spec["gs_name"]); ?></td>
                </td> 
                <td><?php echo ($spec["gs_order"]); ?></td>
				<td>
                    <?php if($spec["gs_show_type"] == 1): ?>退款
                    <?php elseif($spec["gs_show_type"] == 2): ?>
                    退货<?php endif; ?>
				</td>
                <td>
					<?php if($spec["gs_input_type"] == 1): ?>文本框
