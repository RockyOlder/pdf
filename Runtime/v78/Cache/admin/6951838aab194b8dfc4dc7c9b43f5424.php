...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="point_set" name="point_set" method="post" action="<?php echo U('Admin/Coupon/doSet');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">优惠券获取节点</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    <td class="first">获得优惠券节点：</td>
                    <td>
                        <input type="radio" name="GET_COUPON_SET" value="0" <?php if(($GET_COUPON_SET) == "0"): ?>checked="checked"<?php endif; ?> /> 付款后
                        <input type="radio" name="GET_COUPON_SET" value="1" <?php if(($GET_COUPON_SET) == "1"): ?>checked="checked"<?php endif; ?> /> 发货后
                        <input type="radio" name="GET_COUPON_SET" value="2" <?php if(($GET_COUPON_SET) == "2"): ?>checked="checked"<?php endif; ?> /> 确认收货后
                        <input type="radio" name="GET_COUPON_SET" value="3" <?php if(($GET_COUPON_SET) == "3"): ?>checked="checked"<?php endif; ?> /> 订单完成后
                    </td>
                </tr>
            </tbody>
			<tfoot>
...
<script type="text/javascript">
$(function(){
  $("input[name='is_consumed']").click(function(){
