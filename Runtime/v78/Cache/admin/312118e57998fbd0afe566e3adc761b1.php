...
<html>
    ...
    <body>
        ...
        <div class="fx_loginCon"><!--fx_loginCon  start-->
            ...
            <div class="loginForm">
                <div id="resultMsg" redirect_url="<?php echo ($redirect_url); ?>"></div>
                ...
                <div class="yanzheng" id="yanzheng" style="display: none;">
                    <span><img id="verify" src="<?php echo U('Admin/User/verify');?>" class="changeVerify" style="cursor: pointer;" title="点击更新验证码" /></span>
...
function login(){
	...
	var rand = '<?php echo (session('pwd_salt')); ?>'.toString();
