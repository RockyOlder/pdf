...
<div class="rightInner">
    <form id="top_ad_set" name="top_ad_set" method="post" action="<?php echo U('Admin/Home/doAppPic');?>" >
        <table class="tbForm" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="<?php echo (($APP_REGISTER_PIC)?($APP_REGISTER_PIC):'__PUBLIC__/Admin/images/product_image_desc.png'); ?>" id="SHOW_TOP_AD_1" style="width:50px;height:50px;" />
                    &nbsp;
                    <input type="hidden" id="GY_SHOP_TOP_AD_1" name="GY_SHOP_TOP_AD_1" value="<?php echo ($APP_REGISTER_PIC); ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <img src="<?php echo (($APP_LOGIN_PIC)?($APP_LOGIN_PIC):'__PUBLIC__/Admin/images/product_image_desc.png'); ?>" id="SHOW_TOP_AD_2" style="width:50px;height:50px;" />
                    &nbsp;
                    <input type="hidden" id="GY_SHOP_TOP_AD_2" name="GY_SHOP_TOP_AD_2" value="<?php echo ($APP_LOGIN_PIC); ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <img src="<?php echo (($APP_ICO_PIC)?($APP_ICO_PIC):'__PUBLIC__/Admin/images/product_image_desc.png'); ?>" id="SHOW_TOP_AD_3" style="width:50px;height:50px;" />
                    &nbsp;
                    <input type="hidden" id="GY_SHOP_TOP_AD_3" name="GY_SHOP_TOP_AD_3" value="<?php echo ($APP_ICO_PIC); ?>"/>
                </td>
            </tr>
            <!--<tr>-->
                ...
                <!--<td>-->
                    ...
                    <!--<img src="<?php echo (($APP_LOGO_PIC)?($APP_LOGO_PIC):'__PUBLIC__/Admin/images/product_image_desc.png'); ?>" id="SHOW_TOP_AD_4" style="width:50px;height:50px;" />-->
                    <!--&nbsp;-->
                    <!--<input type="hidden" id="GY_SHOP_TOP_AD_4" name="GY_SHOP_TOP_AD_4" value="<?php echo ($APP_LOGO_PIC); ?>"/>-->
                <!--</td>-->
            <!--</tr>-->
            </tbody>
            <tfoot>
