...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="member_form" name="member_form" method="post" action="<?php echo U('Admin/Members/doSet');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">会员设置</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="first">是否自动审核：</td>
                    <td>
                        <input type="radio" value="1" name="MEMBER" <?php if($MEMBER_STATUS["sc_value"] == 1): ?>checked="checked"<?php endif; ?>> 是
                        <input type="radio" value="0" name="MEMBER" <?php if($MEMBER_STATUS["sc_value"] == 0): ?>checked="checked"<?php endif; ?>> 否
                    </td>                    
            ...
            <tbody>
                <tr>
                    <td class="first">登录是否验证验证码：</td>
                    <td>
                        <input  type="radio" value="1" name="VERIFICATION" <?php if($VERIFICATION_STATUS["sc_value"] == 1): ?>checked="checked"<?php endif; ?>> 是
                        <input  type="radio" value="0" name="VERIFICATION" <?php if($VERIFICATION_STATUS["sc_value"] == 0): ?>checked="checked"<?php endif; ?>> 否
                    </td>                    
                    <td><label class="msgClass"></label></td>
                </tr>             
            </tbody>
            <tbody>
                <tr>
                    <td class="first">是否开启手机验证：</td>
                    <td>
                        <input  type="radio" value="1" name="VERIFIPHONE" <?php if($VERIFIPHONE_STATUS["sc_value"] == 1): ?>checked="checked"<?php endif; ?>> 是
                        <input  type="radio" value="0" name="VERIFIPHONE" <?php if($VERIFIPHONE_STATUS["sc_value"] == 0): ?>checked="checked"<?php endif; ?>> 否
                    </td>                    
                    <td><label class="msgClass"></label></td>
                </tr>             
            </tbody>
			<tbody>
                <tr>
                    <td class="first">是否开启邮箱验证：</td>
                    <td>
                        <input  type="radio" value="1" name="VERIFYEMAIL" <?php if($VERIFYEMAIL_STATUS["sc_value"] == 1): ?>checked="checked"<?php endif; ?>> 是
                        <input  type="radio" value="0" name="VERIFYEMAIL" <?php if($VERIFYEMAIL_STATUS["sc_value"] == 0): ?>checked="checked"<?php endif; ?>> 否
                    </td>                    
                    <td><label class="msgClass"></label></td>
                </tr>             
            </tbody>
            <tbody>
                <tr>
                    <td class="first">是否开启会员编辑功能：</td>
                    <td>
                        <input  type="radio" value="1" name="MEMBER_EDIT_STATUS" <?php if($MEMBER_EDIT_STATUS["sc_value"] == 1): ?>checked="checked"<?php endif; ?>> 是
                        <input  type="radio" value="0" name="MEMBER_EDIT_STATUS" <?php if($MEMBER_EDIT_STATUS["sc_value"] == 0): ?>checked="checked"<?php endif; ?>> 否
                    </td>                    
                    <td><label class="msgClass"></label></td>
                </tr>             
            </tbody>
            <tbody>
                <tr>
                    <td class="first">是否自动晋升会员等级：</td>
                    <td>
                        <input  type="radio" value="1" name="MEMBERSUPGRADE" <?php if($upgrade["MEMBERSUPGRADE_STATUS"] == 1): ?>checked="checked"<?php endif; ?>> 是
                        <input  type="radio" value="0" name="MEMBERSUPGRADE" <?php if($upgrade["MEMBERSUPGRADE_STATUS"] == 0): ?>checked="checked"<?php endif; ?>> 否
                    </td>                    
                    <td><label class="msgClass"></label></td>
                </tr>             
            </tbody>
            <tbody>
                <tr>
                    <td class="first">会员登陆失效时间设置：</td>
                    <td>
                        <input  type="text" class="input40" value="<?php echo ($EXPIRED_TIME["sc_value"]); ?>" name="EXPIRED_TIME" > 
                    </td>                    
                    <td><label class="msgClass">网站SESSION控制会员登陆状态的时间。(单位:分钟)</label></td>
                </tr>             
            </tbody>
            <tfoot>
                <tr>
