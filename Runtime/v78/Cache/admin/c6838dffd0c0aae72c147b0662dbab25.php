...
<form method="get" action="<?php echo U('Admin/GoodsCategory/doDel');?>" id="">
	...
	<tfoot>
		<tr>
			<td colspan="99"><input type="submit" value="删除选中"
				...
				class="right page" style="float: left;"><?php echo ($page); ?></span></td>
		</tr>
	</tfoot>
</table>
</form>
...
$(document).ready(function(){
	 <?php if(is_array($pids)): $i = 0; $__LIST__ = $pids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pid): $mod = ($i % 2 );++$i;?>var cid = "<?php echo ($pid); ?>";
	if(cid != ''){
...
//显示子分类
	...
	//选中
	 ...
	 $("#addCategory").click(function(){
		location.href = "<?php echo U("Admin/GoodsCategory/addCategory");?>";
	 });
