...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="count_edit" name="count_edit" method="post" action="<?php echo U('Admin/Seo/doCount');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">修改第三方统计脚本设置</th>
                </tr>
            </thead>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <textarea class="largeBox" name="sc_memo"><?php echo ($info["sc_memo"]); ?></textarea>
                    </td>
                    <td class="last">请参考第三方统计代码网站设置</td>
                </tr>
            </tbody>
