...
<div class="rightInner">
    <form id="members_form" name="members_form" method="post" action="<?php echo U('Admin/Sourceplatform/doEdit');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">会员来源平台编辑</th>
                </tr>
            </thead>
            <tbody> 
                <tr>
                    <td class="first">平台名称：</td>
                    <td>
                        <input type="text" name="sp_name" id="sp_name" class="medium" value="<?php echo ($platform["sp_name"]); ?>" validtae="{ required:true}"/> <br> 
                        <input type="hidden" name="sp_id" id="sp_name" class="medium" value="<?php echo ($platform["sp_id"]); ?>"/> 
                    </td>
                    <td class="last">请输入平台中文名字</td>
                </tr>
                <tr>
                    <td class="first">平台代码：</td>
                    <td>
                        <input type="text" name="sp_code" id="sp_code" class="medium" value="<?php echo ($platform["sp_code"]); ?>" validate='{ required:true,username:true,remote:"<?php echo U("Admin/Sourceplatform/checkSourceplatformCode","filed=sp_code&msg=等级代码");?>"}' /> <br> 
                    </td>
                    <td class="last">请输入平台代码</td>
                </tr>
                <tr>
                    <td class="first">有效/无效：</td>
                    <td>
            <input type="radio" name="sp_stauts" <?php if($platform[sp_stauts] == 1): ?>checked="checked"<?php endif; ?> value="1" />有效<input type="radio"  <?php if($platform[sp_stauts] == 0): ?>checked="checked"<?php endif; ?> name="sp_stauts" value="0" />无效
                    </td>
                    <td class="last">请输入平台代码</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="99">
                        ...
                        <input type="button" value="取 消" onClick="onUrl('<?php echo U("Admin/Sourceplatform/pageList");?>');" class="btnA" >
                    </td>
                </tr>
            </tfoot>
        </table>
