...
<a href="<?php echo ($bread0["url"]); ?>"><?php echo ($bread0["name"]); ?></a>
 ...
 <?php if(($bread3["name"]) != ""): ?>&nbsp;>&nbsp;<?php echo ($bread3["name"]); endif; ?>
    ...
    <form id="type_form" name="type_form" method="post" action="<?php echo U('Admin/GoodsType/doAddType');?>">
        <table class="tbForm" width="100%">
            <thead>
                <tr class="title">
                    <th colspan="99">商品类型添加</th>
                </tr>
            </thead>
            <tbody>
				<tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="gt_name" id="gt_name" class="medium" value="" validate='{ required:true,remote:"<?php echo U("Admin/GoodsType/checkTypeName","msg=类型名称");?>"}' /> <br> 
                    </td>                    
            ...
            <tfoot>
                <tr>
                    <td colspan="99">
						<input type="hidden" name="jump" id="pageJumpType" value="0" />
                        <input type="submit" value="保存" jump="0" class="btnA" >
                        <input type="submit" value="保存并添加属性" jump="1" class="btnA" >
