...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head lang="en">
        ...
        <link rel="stylesheet" type="text/css" href="/Public/Tpl/v78/<?php echo ($view); ?>/css/clientstyle.css?v=c5259037c2"/>
        <script src="/Public/Tpl/v78/<?php echo ($view); ?>/js/jquery-1.4.2.min.js?v=10092eee56" type="text/javascript" charset="utf-8"></script>
        <script src="/Public/Tpl/v78/<?php echo ($view); ?>/js/scanmain.js?v=b40e8a5be1" type="text/javascript" charset="utf-8"></script>
    </head>
    <body>
