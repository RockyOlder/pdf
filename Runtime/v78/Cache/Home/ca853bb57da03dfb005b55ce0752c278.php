...
<html lang="en">
	...
	<body id="goTop"  ><!--      -->
	    ...
	    <script type="text/javascript" src="/Public/Tpl/v78/<?php echo ($view); ?>/js/require.js?v=eb0ef9ae5e" data-main="/Public/Tpl/v78/<?php echo ($view); ?>/js/ConversionFeeDetail"  defer async="true" ></script>    
<div class="main">
        <div class="wrap">
