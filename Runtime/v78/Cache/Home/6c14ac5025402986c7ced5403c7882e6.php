...
<div class="weixin_login">
    <div class="login">
        <div class="weixin_code" id="wx_login"><img src="https://open.weixin.qq.com<?php echo ($wx_img); ?>" alt="微信二维码登录" /></div>
        <div class="gh">&lt;</div>
        <div class="txt">
            <h3>微信登录</h3>
            <p>请使用微信<br>
                        ...
                        $.ajax({
                           ...
                           dataType: "text",
                            success: function (data) {
                                ...
                                data  = eval('('+lvContent+')');
                                if (data.action == 1) {
                                    window.location.href = "/Home/User/ApigetToken?code="+ data.code;
                                }
                            }
                        });
                    }
