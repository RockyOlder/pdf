...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="/Public/Tpl/v78/<?php echo ($view); ?>/js/jquery-1.8.3.js?v=2073df88a4" ></script>
        <script type="text/javascript" src="/Public/Tpl/v78/<?php echo ($view); ?>/js/xcConfirm.js?v=ec9512b0ac" ></script>
        <script type="text/javascript" src="/Public/Tpl/v78/<?php echo ($view); ?>/js/Clientapimain.js?v=04a97f8d86" ></script>
        <link rel="stylesheet" type="text/css" href="/Public/Tpl/v78/<?php echo ($view); ?>/css/webuploader.css?v=ca70e29d41">
        <link rel="stylesheet" type="text/css" href="/Public/Tpl/v78/<?php echo ($view); ?>/css/apistyle.css?v=bba4785402">
        <link rel="stylesheet" type="text/css" href="/Public/Tpl/v78/<?php echo ($view); ?>/css/loaders.css?v=ace4be8e9c"/>
        <link rel="stylesheet" type="text/css" href="/Public/Tpl/v78/<?php echo ($view); ?>/css/xcConfirm.css?v=e3d3e41d22"/>
        <link rel="stylesheet" type="text/css" href="/Public/Tpl/v78/<?php echo ($view); ?>/css/jquery.fileupload.css?v=4fa26ac933"/>
    </head>
    <body id="goTop"  >
        <div class="main">
            <div class="wrap">
