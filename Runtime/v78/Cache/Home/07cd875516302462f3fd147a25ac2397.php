...
<script type="text/javascript" src="/Public/Tpl/v78/<?php echo ($view); ?>/js/require.js?v=eb0ef9ae5e" data-main="/Public/Tpl/v78/<?php echo ($view); ?>/js/main"  defer async="true" ></script>
