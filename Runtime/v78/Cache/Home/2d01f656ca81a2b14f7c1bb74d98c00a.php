            ...
            <?php if($ACTIVITY_OPEN != 1): ?><div class="activity_banner">
                    ...
                    <div class="content">
                       <a href="<?php echo U('Home/Index/YearMiddlePage',array('s_type'=>0));?>" class="Behavior_Statistics_Banner">
                        ...
                        <div class="linkbox">
                            <a href="<?php echo U('Home/Index/YearMiddlePage#04',array('s_type'=>0));?>" class="first">次数套餐买1送1</a>
...
<div class="main_header">
    ...
    <!--<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3004137938&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:574920453:53" alt="点这里给我发消息" /></a>-->
<script> var online = new Array();</script>
  <script type= "text/javascript" src="http://webpresence.qq.com/getonline?Type=1&3004137938:3004137938:" ></script>
<!--<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=574920453&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:574920453:52" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>-->
<script>
      if (online[0]==0)
            document.write( "<a target='blank' href='http://wpa.qq.com/msgrd?v=3&uin=3004137938&site=qq&menu=yes' title='请留言'><img src='__IMAGES__offline.gif' border=0/></a>");
       else
            document.write("<a target='blank'  href='http://wpa.qq.com/msgrd?v=3&uin=3004137938&site=qq&menu=yes' title='在线咨询'><img src='http://wpa.qq.com/pa?p=2:574920453:53' border=0 /></a>");
</script>
