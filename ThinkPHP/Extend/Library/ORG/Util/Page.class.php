...
class Page {
	...
	public function __set($name,$value) {
	    if(array_key_exists($name,get_class_vars('Page'))) {
		    $this->$name = $value;
		}
	}
	
	public function __get($name) {
	    $t_var = get_class_vars('Page');
	    if(array_key_exists($name,$t_var)) {
		    return $t_var[$name];
		}
	}
	...
	*/
	public function mobile_show() {
		...
		if($this->nowPage == 1){
			...
			$preRow = $this->nowPage-$this->rollPage;
            $page = $this->nowPage-1;
			$prePage = str_replace('__PAGE__',$page,$url);
		...
		if($this->nowPage == $this->totalPages){
			...
			$theEndRow = $this->totalPages;
            $page = $this->nowPage+1;
			$nextPage = str_replace('__PAGE__',$page,$url);
