...
abstract class AdminAction extends GyfxAction {
    ...
    private function getTop() {
        ...
        $tops[8] = array('name' => L('NAV1_9'), 'url' => U('Admin/Report/pageList') ,'sn' => 'NAV1_9','type'=>'1,2,3'); //报表功能
        $this->tops = $tops;
...
//        }
      ...
      $menus[2][5][50] = array('name' => L('MENU1_5_50'), 'url' => U('Admin/Bbs/pageDiscuz'),'type'=>'1,2,3'); //论坛内容设置
        ...
        $menus[2][10][0] = array('name' => L('MENU1_10'), 'url' => U('Admin/Advertising/index'),'type'=>'1,2,3');
        $menus[2][10][10] = array('name' => L('MENU1_10_10'), 'url' => U('Admin/Advertising/pageList'),'type'=>'1,2,3'); //来源列表
        $menus[2][10][20] = array('name' => L('MENU1_10_20'), 'url' => U('Admin/Advertising/pageAdd'),'type'=>'1,2,3'); //新增来源链接
...
//         $menus[3][5][50] = array('name' => L('MENU2_5_50'), 'url' => U('Admin/Recources/agreementList'),'type'=>'1,2,3'); //回收合同列表
        ...
        $menus[4][0][15] = array('name' => '订单统计', 'url' => U('Admin/Orders/pageCount'),'type'=>'1,2,3'); //订单统计
        $menus[4][0][20] = array('name' => '待审核订单', 'url' => U('Admin/Orders/pageToAuditOrderList'),'type'=>'1,2,3'); //待审核订单
        $menus[4][0][25] = array('name' => L('MENU3_0_20'), 'url' => U('Admin/Orders/pageWaitPayOrdersList'),'type'=>'1,2,3'); //待付款订单
...
//        $menus[5][0][20] = array('name' => L('MENU4_0_20'), 'url' => U('Admin/Promotions/pageAdd'),'type'=>'1,2,3'); //新建促销活动
       ...
       $menus[5][1][32] = array('name' => L('MENU4_1_32'), 'url' => U('Admin/Coupon/pageRulesList'),'type'=>'1,2,3');//抢优惠券规则列表
        ...
        $menus[5][1][40] = array('name' => L('MENU4_1_40'), 'url' => U('Admin/Coupon/pageSet'),'type'=>'1,2,3');//优惠券获取节点
        $menus[5][1][50] = array('name' => L('MENU4_1_50'), 'url' => U('Admin/Coupon/rulesSet'),'type'=>'1,2,3');//优惠券设置
        //团购活动
...
//         $menus[6][3][10] = array('name' => L('MENU5_3_10'), 'url' => U('Admin//'),'type'=>'1,2,3'); //设置虚拟库存
        ...
        **/
        ...
        //报表系统
        $menus[9][0][0] = array('name' => L('MENU9_0'), 'url' => '#','type'=>'1,2,3');
        $menus[9][0][10] = array('name' => L('MENU9_0_10'), 'url' => U('Admin/Report/index'),'type'=>'1,2,3'); //
...
//				$arr_menu = D('Gyfx')->selectAllCache('menus',null, array('group'=>'Admin','mstatus'=>'1','fid'=>$valmu['id']));
//
//                if(!empty($arr_menu)){
...
//							$arr_menus = D('Gyfx')->selectAllCache('menus',null, array('group'=>'Admin','mstatus'=>'1','fid'=>$vlmu['id']));
//                            if(!empty($arr_menus)){
