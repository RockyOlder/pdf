    ...
    public function pageSetting() {
		...
		if(empty($ary_data['GY_SHOP_QC_LOGO'])){
			...
			$ary_data['GY_SHOP_QC_LOGO'] = D('QnPic')->picToQn($ary_data['GY_SHOP_QC_LOGO']);
                ...
                $ary_data['ACTIVITPPROJECT_TIME'] = date('Y-m-d H:i:s',$ary_data['ACTIVITPPROJECT_TIME']);
                $ary_data['ACTIVITPPROJECT_end_TIME'] = date('Y-m-d H:i:s',$ary_data['ACTIVITPPROJECT_end_TIME']);
...
//        echo '<pre>';print_r($ary_data);die;
        ...
        if(
        	...
        	$SysSeting->setConfig('GY_SHOP', 'ACTIVITY_OPEN', $ary_data['ACTIVITY_OPEN'], '是否开启优惠活动');
        	if(!empty($ary_data['ACTIVITPPROJECT_end_TIME'])){
        		$SysSeting->setConfig('GY_SHOP', 'ACTIVITPPROJECT_end_TIME', strtotime($ary_data['ACTIVITPPROJECT_end_TIME']), '活动结束时间');
        	}
        	if(!empty($ary_data['ACTIVITPPROJECT_TIME'])){
        		$SysSeting->setConfig('GY_SHOP', 'ACTIVITPPROJECT_TIME', strtotime($ary_data['ACTIVITPPROJECT_TIME']), '活动开始时间');
        	}
