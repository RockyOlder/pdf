...
class GoodsProductsModel extends GyfxModel {
    ...
    public function getInventoryLockByCondition($where){
        return $array_inventory_info = D('inventory_pdt_lock')
            ...
            ->field("fx_inventory_pdt_lock.`ipl_num` as ipl_num,fx_inventory_pdt_lock.`iny_pdt_id`,fx_inventory_pdt_lock.`ipl_num_frozen`")
     ...
     */
    public function getProductInfo($outer_id) {
