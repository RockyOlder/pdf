...
class RedisCluster implements ClusterConnectionInterface, \IteratorAggregate, \Countable {
	...
	public function add(SingleConnectionInterface $connection) {
		...
		unset ( $this->slotsMap, $this->slotsPerNode );
	}
	...
	public function remove(SingleConnectionInterface $connection) {
		if (($id = array_search ( $connection, $this->pool, true )) !== false) {
			unset ( $this->pool [$id], $this->slotsMap, $this->slotsPerNode );
	...
	public function removeById($connectionId) {
		if (isset ( $this->pool [$connectionId] )) {
			unset ( $this->pool [$connectionId], $this->slotsMap, $this->slotsPerNode );
	 ...
	 *
	 * @param CommandInterface $command
	 *        	Command that generated the -MOVE or -ASK reply.
	 * @param string $request
	 *        	Type of request (either 'MOVED' or 'ASK').
	 * @param string $details
	 *        	Parameters of the MOVED/ASK request.
	 * @return mixed
	 */
	 ...
	 *
	 * @param CommandInterface $command
	 *        	Command that generated the -ERR reply.
	 * @param ResponseErrorInterface $error
	 *        	Redis error reply object.
	 * @return mixed
	 */
...
class ConnectionParameters implements ConnectionParametersInterface {
	 ...
	 *
	 * @param
	 *        	string|array Connection parameters in the form of an URI string or a named array.
	 */
...
class PhpiredisConnection extends AbstractConnection {
	 ...
	 *        	Specify if Redis errors throw exceptions.
	 * @return \Closure
	 */
...
class Client implements ClientInterface {
	 ...
	 *
	 * @param string $connectionId
	 *        	Index or alias of the connection.
	 ...
	 *
	 * @param mixed $arg,...
	 *        	Options for the context, a callable object, or both.
	 ...
	 *
	 * @param array $options
	 *        	Options of the context initialization.
	 * @param mixed $callable
	 *        	Optional callable object used to execute the context.
	 * @return PipelineContext|array
	 */
