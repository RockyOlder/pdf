...
public function send($ary_option) {
        $this->mailer->IsSMTP();
        $this->mailer->CharSet = 'UTF-8';
        //收件人地址
        $this->mailer->AddAddress($ary_option['receiveMail']);
    ...
    public function testSendMail($email) {
        $xx = 'D:/xampp/htdocs/v78/vpdf/uploadFile/currentfile/20170517/2/pdf/1二次函数——面积-中考数学压轴专项训练-每天练_1494950400.pdf';
       $fileName = iconv('utf-8','gbk//IGNORE',$xx);
        return $this->send(
                        array(
                            'host' => 'smtp.exmail.qq.com',
                            'from' => 'service@cqttech.com',
                            'fromName' => '智城时代',
                            'smtpAuth' => true,
                            'username' => 'service@cqttech.com',
                            'password' => '5C953e38',
                            'port' => 25,
                            'isHtml' => true,
